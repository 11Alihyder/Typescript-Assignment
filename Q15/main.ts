    // Q15. Changing Guest List: You just heard that one of your guests can’t make the dinner, so you need to send out a
...
let guestArry:string[]=["Mahboob ali", "Abu bakar", "hamza", "Talha"]
