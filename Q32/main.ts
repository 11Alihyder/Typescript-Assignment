...
// • Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted.
   ...
   const newUsers: string[] = ['alice', 'Frank', 'bob', 'Grace', 'Heidi'];

   // Loop to check usernames
   newUsers.forEach(username => {
       if (currentUsers.some(currentUser => currentUser.toLowerCase() === username.toLowerCase())) {
           console.log(`${username} is already taken. Please choose a new username.`);
       } else {
