...
var newUsers = ['alice', 'Frank', 'bob', 'Grace', 'Heidi'];
// Loop to check usernames
newUsers.forEach(function (username) {
    if (currentUsers.some(function (currentUser) { return currentUser.toLowerCase() === username.toLowerCase(); })) {
        console.log("".concat(username, " is already taken. Please choose a new username."));
    }
    else {
