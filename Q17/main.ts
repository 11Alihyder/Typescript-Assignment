// Q17. Shrinking Guest List: You just found out that your new dinner table won’t arrive in time for the dinner, and you
...
let guesArry:string[]=["Abu bakar", "Hamza", "Ali","fahad"]
